      ...
      <div className="container-custom text-center">
        <div className="animate-fade-in">
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold mb-6">
            <span className="gradient-text">Vansh Dokania</span>
          </h1>
          
          <p className="text-xl sm:text-2xl lg:text-3xl text-gray-300 mb-8 font-medium">
            DSA Enthusiast | Machine Learning Explorer | IIIT-Delhi
          </p>
          
          <p className="text-lg sm:text-xl text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed">
            I'm a second-year B.Tech ECE student at IIIT-Delhi, passionate about solving algorithmic challenges and building intelligent systems using Python and ML.
          </p>
          ...
          <div className="flex justify-center space-x-6">
            {socialLinks.map((social) => (
              <a
                ...
                className="p-3 bg-dark-800 rounded-full hover:bg-dark-700 transition-all duration-300 hover:scale-110"
